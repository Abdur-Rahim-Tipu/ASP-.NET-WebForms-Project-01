...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class=" row">
        <div class="container-fluid col-12">
            <h1 class="text-center mb-2">TourePackages</h1>
            <span><a class="btn btn-outline-primary mb-3" href="AddPackage.aspx">Add New</a></span>
            <asp:GridView CssClass="table table-bordered table-hover" ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="dsTourePackages" PageSize="5" DataKeyNames="PackageId">
